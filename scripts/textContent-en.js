var textContent_EN = {
  ...
  "experiences": {
    ...
    "membra": {
      ...
      "dateEnd": "Aug 2016",
      "techStack": "",
      "description": "At MES (now Civica) I was part of a team that implemented new features and functionality to a site used by NHS hospitals to gather and present survey data to users.",
      "tasks": [
